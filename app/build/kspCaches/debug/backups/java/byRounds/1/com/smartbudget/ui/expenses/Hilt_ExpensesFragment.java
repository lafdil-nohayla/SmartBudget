...
public abstract class Hilt_ExpensesFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ExpensesFragment() {
    super();
  }

  Hilt_ExpensesFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ExpensesFragment_GeneratedInjector) this.generatedComponent()).injectExpensesFragment(UnsafeCasts.<ExpensesFragment>unsafeCast(this));
    }
  }
